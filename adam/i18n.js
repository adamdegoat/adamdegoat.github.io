...
(function () {
  var DICT = {
    ...
    'Home values · affordability · stamp duty · grants · schools · selling · eligibility,': '房价估值 · 负担能力 · 印花税 · 补贴 · 名校 · 卖房 · 购买资格，',
    ...
    'Start buying': '开始买房',
    "I'm selling": '我要卖房',
    "What it's worth, when you can sell penalty-free, and what you'll actually walk away with, upfront.": '它值多少，什么时候卖不用罚款，以及你最后能实拿多少，先告诉你。',
    'Start selling': '开始卖房',
    'Just exploring': '只是看看',
    ...
    'The toolkit.': '工具箱。',
    'The kind of data the portals keep behind a wall, here, free, for you.': '门户网站收费才给你的数据，这里免费，全给你。',
    ...
    'Near a school': '名校周边', '1km / 2km zones': '1公里 / 2公里范围',
    ...
    'The selling journey end to end, plus the timing traps near the finish line that catch people out.': '从头到尾的卖房流程，以及临近收尾时容易踩的时间陷阱。',
    'Tips': '小贴士',
